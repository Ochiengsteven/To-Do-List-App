...
<div align="center">
  <br/>
  <h3><b> To-Do-List-App Project</b></h3>
</div>
...
***To-Do-List-App***  is a tool that helps to organize your day. It simply lists the things that you need to do and allows you to mark them as complete. This is a simple website that allows for doing that, and I have done the project using ES6 and Webpack!
...
```sh
  cd my-folder
  git clone git@github.com:Ochiengsteven/To-Do-List-App.git
```
